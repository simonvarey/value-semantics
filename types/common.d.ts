...
export declare function setMeta(target: Constructor | BigIntConstructor | SymbolConstructor, key: PropKey, value: unknown): void;
...
export type ValueSemanticsErrorType = 'ErrorOnClone' | 'IncludeAndExclude' | 'IterateNonIterable' | 'IterateNoAddMethod';
